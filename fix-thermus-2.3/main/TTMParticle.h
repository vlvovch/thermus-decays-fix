...
class TTMParticle: public TNamed{
 ...
 private:
  ...
  Bool_t fDecayChainProcessed; // FIX(V. Vovchenko): Added to fix decay contributions
 ...
 public:
  ...
  // FIX(V. Vovchenko): Added to fix decay contributions
  void SetDecayChainProcessed(Bool_t x) { fDecayChainProcessed = x;}
  ...
  // FIX(V. Vovchenko): Added to fix decay contributions
  Bool_t GetDecayChainProcessed() const {return fDecayChainProcessed;}
